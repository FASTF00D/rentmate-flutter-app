...
class EntryFlats extends StatefulWidget {
  const EntryFlats({Key? key, }) : super(key: key);

  @override
  State<EntryFlats> createState() => _EntryFlatsState();
}

class _EntryFlatsState extends State<EntryFlats>
